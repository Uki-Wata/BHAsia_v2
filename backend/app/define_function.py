...
def generate_python_code(input_text):
    ...
    # Bind the input_text to the prompt template
...
def generate_security_precautions(input_text):
    """
    ...
    # Create the chain
    chain = (
        {"context": contexts, "aws_services": RunnablePassthrough()}
        | prompt
        | model
        | StrOutputParser()
    )
...
# original question
original_question = 'what is multi-query search?'
# retrieve documents
